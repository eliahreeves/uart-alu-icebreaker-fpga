...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{uart_echo_sim.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{uart_echo_gls.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{uart_echo.png}
